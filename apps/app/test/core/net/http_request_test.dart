...
void main() {
  ...
  test('Should make a GET request', () async {
    when(mockDio.get<String>("/ping")).thenAnswer(
      (_) => Future(
        () => Response<String>(
  ...
  test('Should make a GET request with header.', () async {
    ...
    r.Response<String> response = await instance.getWithHeader<String>(
      "/ping",
      {'a': 'b'},
    );
    expect(response.body(), "pong");
  ...
  test('Should make a POST request with some headers', () async {
    ...
    r.Response<String> response = await instance.postWithHeader<String>(
      "/ping",
      {},
      {},
    );
  ...
  test('Should make a POST request with connection', () async {
    ...
    r.Response<String> response = await instance.postWithConnection<String>(
      "/ping",
      data: {},
      connection: null,
    );
  ...
  test(
    ...
    () async {
      when(mockDio.get<String>("/ping")).thenThrow(
        DioException(
      ...
      expect(
        () async => await instance.get<String>("/ping"),
  ...
  test(
    ...
    () async {
      ...
      expect(
        () async => await instance.post<String>("/ping", {}),
        throwsA(const TypeMatcher<AuthorizedDeniedException>()),
      );
    },
  );
  ...
  test(
    ...
    () async {
      ...
      expect(
        () async => await instance.put<String>("/ping", {}),
        throwsA(const TypeMatcher<AuthorizedDeniedException>()),
      );
    },
  );
