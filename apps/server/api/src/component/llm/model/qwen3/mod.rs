...
use service::component::llm::TokenConverter;
use service::component::llm::{
    CompletionEvent, CompletionRequest, ContentPart, InputState, Llm, Message, Role, ToolDef,
};
use std::pin::Pin;
...
#[cfg(test)]
mod tests {
    use service::component::llm::{CompletionRequest, ContentPart, Message, Role, ToolDef};
    use tracing_test::traced_test;

    use crate::component::llm::model::qwen3::convert_request_to_prompt;
